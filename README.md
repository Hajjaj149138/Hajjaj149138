...
public class SoftwareEngineer {
    ...
    private final String name     = "Md. Hajjaj Bin Sonosi";
    ...
    public boolean fastLearner() {
        return true; // new stack, new hire
    }

    public static void main(String[] args) {
        System.out.println("Thanks for stopping by — let's build something.");
    }
}
```
...
| | |
|---|---|
| 🎓 | Magna Cum Laude, Silver Medal — AIUB |
| ☕ | Runs on Java by day, coffee by default |
| 🧠 | Fast learner — new stack, new hire |
| 🐛 | Calls it a feature until proven otherwise |
| ❓ | Why did the developer go broke? He used up all the cache. |
| 🔁 | Has visited Stack Overflow more than his own portfolio |
| 🌙 | Best commits happen after the third cup of coffee |
| 🎯 | Believes in `git commit -m "fix"` more than he'd like to admit |
